...
//OLED GPIO
#define OLED_CS_0		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_4, GPIO_PIN_RESET)
#define OLED_CS_1		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_4, GPIO_PIN_SET)

#define OLED_DC_0		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_RESET)
#define OLED_DC_1		HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0, GPIO_PIN_SET)

#define OLED_RST_0		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_5, GPIO_PIN_RESET)
#define OLED_RST_1		HAL_GPIO_WritePin(GPIOC, GPIO_PIN_5, GPIO_PIN_SET)
